"""
Django settings for Kincaid Wolstein LifeCarePlan Application project.
...
SECRET_KEY = env("SECRET_KEY", default="django-insecure-sniheMqM3uSoe5h3CqEQzOJ09LcOQrYo36k9GJoQ")
...
ROOT_URLCONF = "lifecareplan.urls"
...
WSGI_APPLICATION = "lifecareplan.wsgi.application"
...
if "DATABASE_URL" in env:
    ...
    DATABASES = {
        "default": {
            ...
            "NAME": env("DJANGO_DATABASE_NAME", default="lifecareplan"),
...
LANGUAGE_CODE = "en-us"
LANGUAGE_COOKIE_NAME = "lifecareplan_language"
LANGUAGES = [
...
if USE_S3_MEDIA:
    ...
    AWS_STORAGE_BUCKET_NAME = env("AWS_STORAGE_BUCKET_NAME", default="lifecareplan-media")
...
EMAIL_SUBJECT_PREFIX = "[Kincaid Wolstein LifeCarePlan Application] "
...
SPECTACULAR_SETTINGS = {
    "TITLE": "Kincaid Wolstein LifeCarePlan Application",
    "DESCRIPTION": "This is an LCP application for Kincaid Wolstein Vocational and Rehabilitation Services",
    "VERSION": "0.1.0",
...
PROJECT_METADATA = {
    "NAME": gettext_lazy("Kincaid Wolstein LifeCarePlan Application"),
    "URL": "http://localhost:8000",
    "DESCRIPTION": gettext_lazy(
        "This is an LCP application for Kincaid Wolstein Vocational and Rehabilitation Services"
    ),
...
LOGGING = {
    ...
    "loggers": {
        ...
        "lifecareplan": {
            "handlers": ["console"],
            "level": env("LIFECAREPLAN_LOG_LEVEL", default="INFO"),
        },
    },
}
